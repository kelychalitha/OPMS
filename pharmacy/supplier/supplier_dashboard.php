...
<html lang="en" dir="ltr">
    ...
    <body>
      <input type="checkbox" id="check">
        ...
        <div class="sidebar">
            <center>
                <img src="../uploads/supplier/<?php echo ($image)?>" class="profile_image" class="center" alt="Supplier profile image">
        ...
        <div class="content">
            ...
            <h2>Last Five Order Details</h2></br>
            <table>
                <tr>
                    <th>Date</th>
                    <th>Order ID </th>
                ...
                $url= $apiUrl."precription/precs/".$cid;
                $ch = curl_init();
