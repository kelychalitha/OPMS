...
<head>
    ...
    <link rel="stylesheet" href="css/sup-detail.css">
                ...
                if($responseData != null){
                    foreach ($responseData  as $key => $value) {
                        if($value["status"]==="Deactivated"){
                            echo "<tr> <td>".  $value["fname"]. "</td><td> ". $value["lname"]. "</td><td> ". $value["email"]. "</td><td> ". $value["nic"]. "</td><td> "
                            . $value["phone"]. "</td> <td>"  . $value["address"]. "</td>" ?>
                <td>   <form action="controllers/admin/deleteSup.php" method="post">
                            <input type="hidden" name="id" id="sId"  value="<?php echo $value["_id"];?>" >

                          <button class="deacbtn" name="delete" type="submit">Deactivated</button>
                        </form></td>
                        <?php
echo "</tr>";
                        }else{
                ...
                <td>   <form action="controllers/admin/deleteSup.php" method="post">
                          ...
                          <button class="livbtn" name="delete" type="submit">Live</button>
                        </form></td>
                        <?php
echo "</tr>";
                        }
