...
else
{
  ...
  <head>
    <link rel="stylesheet" href="css/supreg.css">
    <meta charset="utf-8">
        ...
        <a href="#" class="navbar-brand"><img src="images/a.jpg"
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="supreg.php" class="nav-link active">Supplier Register</a></li>
 ...
 <div class="page-header">
    ...
    <div class="blog">
        ...
        <div class="container-fluid">
            <form action="controllers/auth/supReg.php" method="post"  enctype="multipart/form-data">
               ...
               <!-- <div class="row rows form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="phone2" placeholder="Contact Number" value="" required>
                    </div>
                </div> -->
                <div class="row rows form-group">
                    <div class="col-lg-4 text-lg-right">
                ...
                <div class="row rows form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="Password" class="form-control" name="password" placeholder="Passward" value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"  required>
                    </div>
                </div>
                <div class="row rows form-group">
                    <div class="col-lg-4 text-lg-right">
