...
class SuAboutUs extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              Stack(children: [
                Image(
                    image: NetworkImage(
                        "https://pharmacytimes.s3.amazonaws.com/v1_media/Fotolia_132398971_Subscription_XXL.jpg")),
                Opacity(
                    opacity: 0.3,
                    child: Container(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          "• ",
                          style: TextStyle(color: Colors.grey[600], fontSize: 35.0),
                        ),
                        Expanded(
                          child: Text(
                            'ePharmacy - Pharmacy Management System is a very convenient, flexible to use. It is specially designed to fulfill the medical requirements of the people.',
                            style:
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'As per security measures, we woukld like to get some of your personal information. Hopefully, you can get a quick service from this system. ',
                            style:
                                TextStyle(color: Colors.grey[600], fontSize: 18.0),
                            maxLines: 54,
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'You have to do a very small thing. First of all, if someone wants to buy their medicines through a system like this, He/She shoul access this system and find the nearest pharmacy by using the googke maps. And then they shall send their prescription to that selected pharmacy.',
                            style:
                                TextStyle(color: Colors.grey[600], fontSize: 18.0),
                            maxLines: 54,
                          ),
