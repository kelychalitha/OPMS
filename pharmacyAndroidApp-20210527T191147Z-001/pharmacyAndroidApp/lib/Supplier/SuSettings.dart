...
class SuSettings extends StatefulWidget {
  @override
  _SuSettingsState createState() => _SuSettingsState();
}

var id, fnm, lnm, nc, mail, cpw;

class _SuSettingsState extends State<SuSettings> {
  TextEditingController _password = TextEditingController();
  TextEditingController _fname = TextEditingController();
  TextEditingController _lname = TextEditingController();
  TextEditingController _nic = TextEditingController();
  TextEditingController _email = TextEditingController();
  TextEditingController _curpassword = TextEditingController();
  void initState() {
    super.initState();
    user();
  }
  ...
  user() async {
    ...
    fnm = prefs.getString("fname1");
    lnm = prefs.getString("lname1");
    mail = prefs.getString("userEmail1");
    nc = prefs.getString("nic1");
    cpw = prefs.getString("password1");
    // final response = await http.get("$ip/auth/getPassword/$id");
  ...
  Future<String> update(fname, lname, password, email, nic) async {
    print(id);
    var url = "$ip/auth/updateSupplierm"; //
    ...
    if (parse == 201 || parse == 200) {
      ...
      AwesomeDialog(
        ...
        btnCancelOnPress: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => SuSettings()));
        },
        btnOkOnPress: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => SuSettings()));
